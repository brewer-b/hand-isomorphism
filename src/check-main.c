...
int main(int argc, char **argv) {
  ...
  hand_indexer_t *preflop_indexer = hand_indexer_init(1, (uint8_t[]){2});

  hand_indexer_t *flop_indexer = hand_indexer_init(2, (uint8_t[]){2, 3});

  hand_indexer_t *turn_indexer = hand_indexer_init(3, (uint8_t[]){2, 3, 1});

  hand_indexer_t *river_indexer = hand_indexer_init(4, (uint8_t[]){2, 3, 1, 1});
